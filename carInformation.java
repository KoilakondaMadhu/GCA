...
public class CarInformation {
		...
		String[] carmodel = { "Sedan", "HatchBack", "5Seater", "Sedan", "HatchBack" };   //car models list
		double[] rating = { 4, 4.3, 4.8, 4.1, 4.7 };   // rating of the car model 
		int[] distance = { 500, 1, 200, 700, 430 };    // distance from Customer
